...
const elements = document.querySelectorAll('[data-range]');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialize Particle object with your access token
        const particle = new Particle();
        const accessToken = '3d05d03c3074d2fc6961feaae13b2ee84b91fcc6';
        
        slider.addEventListener('input', function() {
          const sliderValue = slider.value;
          // Call a function to send the slider value to your Particle Photon device
          sendSliderValue(sliderValue);
        });
        
        function sendSliderValue(value) {
          particle.callFunction({ deviceId: '420025000447313137363331', name: 'setTime', argument: String(value), auth: accessToken })
            .then(function(data) {
